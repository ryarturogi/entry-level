...
const jobCategories = POST_JOB_SELECTION_OPTIONS.categories.map((category) => ({
  id: category.toLocaleLowerCase().replace(/\s/g, '-'),
  name: category,
}));
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 mt-6 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            <div className="sm:col-span-4">
              ...
              <div className="flex mt-1 rounded-md shadow-sm">
                <span className="inline-flex items-center px-3 text-gray-500 border-2 border-r-0 border-primary-100 rounded-l-md bg-gray-50 sm:text-sm">
                  Position
                </span>
                <input
                  autoComplete="new-password"
                  className="flex-1 block w-full min-w-0 rounded-none border-primary-100 rounded-r-md focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                  id="job-title"
                  name="jobTitle"
              ...
              <div className="mt-1">
                {jobCategories?.length > 0 && (
                  <Select
                    ...
                    optionsSelected={formData.category ? [formData.category] : []}
                    placeholder="Select a category"
                  />
                )}
                {formData.category && (
                  <div className="mt-2">
                    <span className="inline-block px-3 py-1 text-sm font-medium text-white rounded-full bg-primary-500">
                      {formData.category}
                    </span>
                  </div>
                )}
              ...
              <div className="space-y-4">
                <div className="relative flex items-start">
                  <div className="flex items-center h-5">
                    <input
                      className="w-4 h-4 border-2 rounded border-primary-100 text-primary-600 focus:ring-primary-500"
                      id="worldwide"
                      name="worldwide"
                      onChange={handleChange}
                      type="checkbox"
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-1">
                ...
                <div className="flex items-center">
                  <input
                    className="w-4 h-4 rounded border-primary-100 text-primary-600 focus:ring-primary-500"
                    id="full-time"
                    name="jobType"
                    onChange={handleChange}
                    type="radio"
                  ...
                  <input
                    className="w-4 h-4 ml-6 rounded border-primary-100 text-primary-600 focus:ring-primary-500"
                    id="contract"
                    name="jobType"
                    onChange={handleChange}
                    type="radio"
            ...
            <div className="sm:col-span-6">
              ...
              <div className="mt-1">
                <textarea
                  className="block w-full border-2 rounded-md shadow-sm border-primary-100 focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                  defaultValue={''}
                  id="job-description"
                  name="jobDescription"
                  onChange={handleChange}
                  ...
                  <button
                    className={`${
                      isGeneratingDescription || !formData.jobTitle || formData.jobDescription
                        ...
                        : 'bg-primary-500 hover:bg-primary-700 text-white focus:ring-primary-500 cursor-pointer '
                    } px-4 py-2 font-medium text-sm rounded-md
                      inline-flex justify-center ml-3 border-2 border-transparent shadow-sm focus:outline-none focus:ring-2  focus:ring-offset-2
                      `}
                    disabled={
                      isGeneratingDescription || !formData.jobTitle || formData.jobDescription
                    }
                  ...
                  >
                    {(!isGeneratingDescription && <span>Generate Job Description</span>) || (
                      <div className="flex items-center space-x-2">
                        <svg
                          className="w-5 h-5 mr-3 -ml-1 text-primary-500 animate-spin"
                          fill="none"
                          viewBox="0 0 24 24"
            ...
            <div className="grid grid-cols-1 mt-6 gap-y-6 gap-x-4 sm:grid-cols-6">
              <div className="sm:col-span-3">
                ...
                <div className="mt-1">
                  <input
                    autoComplete="new-password"
                    className="block w-full rounded-md shadow-sm border-primary-100 focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                    id="company-name"
                    name="companyName"
                    onChange={handleChange}
                    type="text"
        ...
        <div className="pt-5">
          <div className="flex justify-end">
            <button
              className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border-2 rounded-md shadow-sm border-primary-100 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
              type="button"
            >
              Cancel
            </button>
            <button
              className="inline-flex justify-center px-4 py-2 ml-3 text-sm font-medium text-white border-2 border-transparent rounded-md shadow-sm bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
